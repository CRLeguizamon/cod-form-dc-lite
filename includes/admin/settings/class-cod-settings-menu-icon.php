...
class CODL_Settings_Menu_Icon extends CODL_Settings_Abstract {
    /**
     * Constructor
     */
    public function __construct() {
        $this->id = 'menu_icon';
        $this->title = esc_html__('Ícono del carrito', 'cod-form-dc-lite');
        parent::__construct();
    }
    ...
    public function get_settings() {
        return array(
            array(
                'title' => esc_html__('Configuración del Ícono del Carrito', 'cod-form-dc-lite'),
                'type'  => 'title',
                'desc'  => esc_html__('<p>Esta sección te permite personalizar el ícono del carrito que aparece en el menú de navegación de tu tienda. El ícono del carrito es una herramienta útil que:</p>
                              ...
                              <p>Puedes personalizar el color y tamaño del ícono para que combine con el diseño de tu sitio.</p>', 'cod-form-dc-lite'),
                'id'    => 'cod_form_menu_icon_section_title'
            ),
            array(
                'title'    => esc_html__('Color del ícono', 'cod-form-dc-lite'),
            ...
            array(
                'title'    => esc_html__('Tamaño del ícono', 'cod-form-dc-lite'),
                'desc'     => esc_html__('Ajusta el tamaño del ícono del carrito en píxeles. Recomendaciones:
                                ...
                                <p>Ten en cuenta que un tamaño demasiado grande puede afectar el diseño de tu menú.</p>', 'cod-form-dc-lite'),
            ...
            array(
                'title'    => esc_html__('Shortcode para el ícono', 'cod-form-dc-lite'),
                'desc'     => esc_html__('<p>Usa este shortcode para mostrar el ícono del carrito en cualquier parte de tu sitio:</p>
                                ...
                                <p>Esto cambiará el color del ícono a <code>#f2f2f2</code> sin afectar la configuración general.</p>', 'cod-form-dc-lite'),
